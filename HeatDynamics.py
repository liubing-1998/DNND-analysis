...
DNND原结果  HeatDynamics  k=1  : 结果不好的原因，节点状态值很快趋于一致，没有学习样本了
python HeatDynamics.py --dynamic HeatDynamics --hidden_A_list 2 8 1 --hidden_list 0 --network grid --viz --dump --init_random --seed 456 --count 0_1
# 计算出F+G

DNND原结果  HeatDynamics  k=0.01  : long-term预测结果不好，也是缺样本？？
python HeatDynamics.py --dynamic HeatDynamics --hidden_A_list 2 8 1 --hidden_list 0 --network grid --viz --dump --init_random --seed 456 --count 0_2

k=5  : 
python HeatDynamics.py --dynamic HeatDynamics --hidden_A_list 2 8 1 --hidden_list 0 --network grid --viz --dump --init_random --seed 456 --count 0_3

k=2  
python HeatDynamics.py --dynamic HeatDynamics --hidden_A_list 2 8 1 --hidden_list 0 --network grid --viz --dump --init_random --seed 456 --count 0_4

k=1.5 
python HeatDynamics.py --dynamic HeatDynamics --hidden_A_list 2 8 1 --hidden_list 0 --network grid --viz --dump --init_random --seed 456 --count 0_5

k=0.8
python HeatDynamics.py --dynamic HeatDynamics --hidden_A_list 2 8 1 --hidden_list 0 --network grid --viz --dump --init_random --seed 456 --count 0_6

k=0.5
python HeatDynamics.py --dynamic HeatDynamics --hidden_A_list 2 8 1 --hidden_list 0 --network grid --viz --dump --init_random --seed 456 --count 0_7
