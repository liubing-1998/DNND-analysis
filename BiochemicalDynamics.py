...
parser.add_argument('--activation_function', type=str, default='Tanh', help='activation_function')
        ...
        if itr % args.test_freq == 0 or itr == 1:
            with torch.no_grad():
                ...
                if args.sampled_time == 'irregular':
                    ...
                    print('Iter {:04d}| Train Loss {:.6f}({:.6f} Relative) | Test Loss {:.6f}({:.6f} Relative) | '
...
'''
bad-case --- 测试  BiochemicalDynamics(nn.Module):  self.A = A self.f = 1 self.b = 0.1 self.r = 0.01
...
BiochemicalDynamics(nn.Module):  self.A = A self.f = 1 self.b = 0.1 self.r = 0.1
python BiochemicalDynamics.py --dynamic BiochemicalDynamics --hidden_A_list 2 8 1 --hidden_list 1 8 1 --network grid --init_random --viz --dump --seed 671 --count  0_1

BiochemicalDynamics(nn.Module):  self.A = A self.f = 1 self.b = 0.5 self.r = 0.1
python BiochemicalDynamics.py --dynamic BiochemicalDynamics --hidden_A_list 2 8 1 --hidden_list 1 8 1 --network grid --init_random --viz --dump --seed 671 --count  0_2
