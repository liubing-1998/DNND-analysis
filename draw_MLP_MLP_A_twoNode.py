...
def x_truef_mlpf_figure(x, true_y_f, mlp_y_f, dynamic):
    fig = plt.figure()
...
def x_trueg_mlpg_figure(x, true_y_g, mlp_y_g, X, Y, dynamic):
    ...
    ctf2 = axsnest[1].contour(X, Y, mlp_y_g.cpu().detach().numpy(), levels=levels, cmap=plt.cm.hot)
...
if __name__ == '__main__':
        ...
        for network in network_list:
            ...
            for filepath in file_name_list:
                ...
                if dynamic == 'BiochemicalDynamics':
                    ...
                    # print(filepath)  # .\results\HeatDynamics\grid\result_HeatDynamics_grid_0802-231540_0.pth
                    # print(filename)  # result_HeatDynamics_grid_0802-231540_0
    ...
    read_heat_result(filepath, filename, k=1)
